...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Attribute Value Table</h6>

        <hr />
        <div class="col">
            <button type="button" class="btn btn-outline-info px-5 radius-30 " onclick="saveData('0','','')"
                data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Attribute Value</button>
        </div>
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button"
                                    ...
                                    <button onclick="deleteData('{{$list->id}}','attribute_values')"
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formSubmit" action="{{url('admin/update_attribute_value')}}" method="POST"
                ...
                <div class="modal-body">
                    <div class="border p-4 rounded">
                        ...
                        <hr />
                        <div class="row mb-3">
                            <label for="enter_name" class="col-sm-3 col-form-label">Attribute Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            <label for="enter_slug" class="col-sm-3 col-form-label">Attribute Value</label>
                            <div class="col-sm-9">
...
<script>
    function saveData(id, attr_id, value) {
        $('#enter_id').val(id);
        $('#attributes_id').val(attr_id);
