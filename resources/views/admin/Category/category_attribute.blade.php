        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <h6 class="mb-0 text-uppercase">ADD category attribute</h6>
                        <hr/>
                        <div class="col">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="saveData('0','','')" class="btn btn-outline-info px-5 radius-30">Add ADD category attribute</button>
                                            </div>
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$list['attribute']->name}}</td>
                                                 <td><button type="button" onclick="saveData('{{$list->id}}','{{$list->category_id}}','{{$list->attribute_id}}')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Update</button>
