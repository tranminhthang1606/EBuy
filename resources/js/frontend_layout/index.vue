        ...
        <template v-slot:content>
            ...
            <section class="slider-area position-relative">
                <div class="third-slider-active">
                    <div v-for="item in homeBanners" :key="item.id" class="third-slider-item third-slider-bg"
                        style="background-image : url('frontend_assets/img/slider/third_slider_bg.jpg')"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img :src="item.image" style="height: 537px;width: 560px;" alt=""
                        ...
                        <div v-for="item in getShortArray(3)" :key="item.id" class="col-lg-4 col-md-6 col-sm-9">
                            <div class="shoes-cat-item mb-50">
                                <div class="thumb mb-30">
                                    <a href="shop-sidebar.html"><img :src="item.image" alt=""
                    ...
                    <div class="row no-gutters trending-product-grid">
                        <div class="col-2">
                            <div class="trending-products-list">
                                ...
                                <ul class="nav nav-tabs" id="trendingTab" role="tablist">
                                    <li v-for="(cateItem, index) in getShortArray(6)" :key="cateItem.id"
                                        class="nav-item" role="presentation">
                                        <a :class="'nav-link '+showActiveClass(1, index)"
                                            :id="'cat-tab'+cateItem.id" data-toggle="tab" :href="'#cat'+cateItem.id" role="tab"
                                            :aria-controls="'cat'+cateItem.id" aria-selected="true">{{ cateItem.name }}</a>
                        ...
                        <div class="col-10">
                            <div class="tab-content tp-tab-content" id="trendingTabContent">
                                <div v-for="(cateItem, index) in getShortArray(6)" :class="'tab-pane ' +showActiveClass(2, index)" :id="'cat'+cateItem.id" role="tabpanel"
                                    :aria-labelledby="'cat-tab'+cateItem.id">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img
                                                :src="cateItem.image" alt=""></a>
                                    </div>
                                    <div v-if="cateItem.products.length > 0" class="row trending-product-active">
                                        <div v-for="item in cateItem.products" class="col">
                                            <div class="features-product-item">
                                                ...
                                                <div class="features-product-content">
                                                    ...
                                                    <p class="price">${{ item.product_attributes[0].price }}</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="new-arrival-nav mb-35">
                                <button v-for="(cateItem, index) in getShortArray(6)" :key="cateItem.id" :class="'.'+showActiveClass(1,index)" :data-filter="'.cat-'+cateItem.id">{{ cateItem.name }}</button>
            ...
            <div class="instagram-post-area">
                <div class="container-fluid p-0 fix">
                    <div class="row no-gutters insta-active">
                        <div v-for="item in homeBanners" class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img style="height: 300px;width: 100%;" :src="item.image" alt="">
                                </a>
                            </div>
                        </div>
