            ...
            <section class="slider-area position-relative">
                <div class="third-slider-active">
                    <div class="third-slider-item third-slider-bg"
                        style="background-image : url('frontend_assets/img/slider/third_slider_bg.jpg')" data-background="frontend_assets/img/slider/third_slider_bg.jpg">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img src="/frontend_assets/img/slider/third_slider_img01.png" alt=""
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img src="/frontend_assets/img/slider/third_slider_img02.png" alt=""
                                                class="main-img" data-animation-in="slideInRight2" data-delay-in="1"
                                                data-duration-in="1.5">
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img src="/frontend_assets/img/slider/third_slider_img03.png" alt=""
                                                class="main-img" data-animation-in="slideInRight2" data-delay-in="1"
                                                data-duration-in="1.5">
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img src="/frontend_assets/img/slider/third_slider_img04.png" alt=""
                                                class="main-img" data-animation-in="slideInRight2" data-delay-in="1"
                                                data-duration-in="1.5">
                                        </div>
                                    </div>
                ...
                <div class="container custom-container-two">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="shoes-cat-item mb-50">
                                <div class="thumb mb-30">
                                    <a href="shop-sidebar.html"><img src="/frontend_assets/img/images/shoes_cat_img01.jpg"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="shoes-cat-item mb-50">
                                <div class="thumb mb-30">
                                    <a href="shop-sidebar.html"><img src="/frontend_assets/img/images/shoes_cat_img02.jpg"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="shoes-cat-item mb-50">
                                <div class="thumb mb-30">
                                    <a href="shop-sidebar.html"><img src="/frontend_assets/img/images/shoes_cat_img03.jpg"
                                            alt=""></a>
                                </div>
                                <div class="content">
                                    <ul>
                                ...
                                <ul class="nav nav-tabs" id="trendingTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="bSellers-tab" data-toggle="tab" href="#bSellers"
                                            role="tab" aria-controls="bSellers" aria-selected="false">Haiki Shoes</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                        ...
                        <div class="col-10">
                            <div class="tab-content tp-tab-content" id="trendingTabContent">
                                <div class="tab-pane show active" id="accessories" role="tabpanel"
                                    ...
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img
                                                src="/frontend_assets/img/images/trending_banner03.jpg" alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                            ...
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    ...
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product01.jpg" alt="">
                                                    </a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product02.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product03.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product04.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product05.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product06.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                ...
                                <div class="tab-pane" id="bags" role="tabpanel" aria-labelledby="bags-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img
                                                src="/frontend_assets/img/images/trending_banner02.jpg" alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product07.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/frontend_assets/img/product/shoes_product08.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a>
                                ...
                                <div class="tab-pane" id="bSellers" role="tabpanel" aria-labelledby="bSellers-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img src="/frontend_assets/img/images/trending_banner.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
                    ...
                    <div class="row new-arrival-active">
                            ...
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product01.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <div class="discount-tag">- 20%</div>
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product02.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product03.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    ...
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product04.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <div class="discount-tag">- 20%</div>
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product05.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <div class="discount-tag new">New</div>
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product06.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product07.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    ...
                                    <a href="shop-details.html"><img
                                            src="/frontend_assets/img/product/shoes_arrival_product08.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
            ...
            <section class="shoes-banner-area">
                <div class="container">
                    <div class="shoes-banner-active">
                        <div class="shoes-banner-bg" data-background="/frontend_assets/img/bg/shoes-banner_bg.jpg">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 col-sm-8">
                            <div class="promo-services-item mb-40">
                                <div class="icon"><img src="/frontend_assets/img/icon/promo_icon01.png" alt=""></div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-8">
                            <div class="promo-services-item mb-40">
                                <div class="icon"><img src="/frontend_assets/img/icon/promo_icon02.png" alt=""></div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-8">
                            <div class="promo-services-item mb-40">
                                <div class="icon"><img src="/frontend_assets/img/icon/promo_icon03.png" alt=""></div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-8">
                            <div class="promo-services-item mb-40">
                                <div class="icon"><img src="/frontend_assets/img/icon/promo_icon04.png" alt=""></div>
                                <div class="content">
                        ...
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    ...
                                    <img src="/frontend_assets/img/instagram/s_insta_post01.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/frontend_assets/img/instagram/s_insta_post02.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/frontend_assets/img/instagram/s_insta_post03.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/frontend_assets/img/instagram/s_insta_post04.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/frontend_assets/img/instagram/s_insta_post05.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
