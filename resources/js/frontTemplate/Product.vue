                            ...
                            <div class="row">
                                <div class="col-lg-3 d-none d-lg-block">
                                    <div class="previous-product">
                                        <a href="shop-details.html"><i class="fas fa-angle-left"></i> previous
                                            product</a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="breadcrumb-content">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Tracker Jacket
                                                </li>
                                            </ol>
                                        </nav>
                                    </div>
                                        ...
                                        <div class="product-details-info">
                                            ...
                                            <div class="sidebar-product-size mb-30">
                                                ...
                                                <div class="shop-size-list">
                                                    <ul>
                                                        <li v-for="item in uniqueSizes"><a href="javascript:void(0)" v-on:click="showColor(item),
                                                          this.size = item  " :class="this.size == item ? sizeColor:''" >{{ item }}</a></li>
                                            ...
                                            <div class="sidebar-product-color">
                                                ...
                                                <div class="shop-color-list">
                                                    <ul>
                                                        <li v-for="item in uniqueColors" v-on:click="this.color.id = item.id , this.color.text = item.text, this.color.product_attr_id = item.product_attr_id" :style="{backgroundColor : item.value}" :class="this.color.id == item.id ? colorColor : ''"></li>
                                            ...
                                            <div class="tab-pane fade" id="reviews" role="tabpanel"
                                                ...
                                                <form action="#" class="comment-form review-form">
                                                    ...
                                                    <div class="comment-check-box">
                                                        ...
                                                        <label for="comment-check">Save my name and email in this
