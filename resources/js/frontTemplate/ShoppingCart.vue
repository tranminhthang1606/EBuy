                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr v-for=" item in slotProps.cartProduct" :key="item.id">
                                                ...
                                                <td class="product-price">Rs {{ item.products[0].product_attributes[0].price }}</td>
                                                <td class="product-quantity">
                                                    <div class="cart-plus-minus">
                                                        <form action="#" class="num-block">
                                                            <input type="text" class="in-num" :value="item.qty" readonly="">
                                                            <div class="qtybutton-box">
                                                                <span class="plus" v-on:click="slotProps.addToCart(item.products[0].id,item.products[0].product_attributes[0].id, item.qty+1)" ><img src="front_assets/img/icon/plus.png" alt=""></span>
                                                                <span class="minus dis" v-on:click="slotProps.addToCart(item.products[0].id,item.products[0].product_attributes[0].id, item.qty-1)"><img src="front_assets/img/icon/minus.png" alt=""></span>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </td>
                                                <td class="product-subtotal"><span>Rs {{ item.products[0].product_attributes[0].price * item.qty }}</span></td>
                                                <td class="product-delete"><a href="javscript:void(0)"  @click="slotProps.removeCartData(item.products[0].id,item.products[0].product_attributes[0].id, item.qty)"><i class="flaticon-trash"></i></a></td>
                                            </tr>
