                                        ...
                                        <div class="sidebar-brand-list">
                                            <ul>
                                                ...
                                                v-on:click="addDataAttr('attribute',attrItem.id)"><a
                                                      :class="this.attribute.includes(attrItem.id) ? brandColor : ''"  href="javascript:void(0)">{{ attrItem.value }} <i
                                        ...
                                        <div class="sidebar-brand-list">
                                            <ul>
                                                ...
                                                v-on:click="addDataAttr('brand',item.id)"><a
                                                      :class="this.brand.includes(item.id) ? brandColor : ''"  href="javascript:void(0)">{{ item.text }} <i
                                                            class="fas fa-angle-double-right"></i></a></li>
                                        ...
                                        <div class="sidebar-product-size mb-30">
                                            ...
                                            <div class="shop-size-list">
                                                <ul>
                                                    ...
                                                    :class="this.size.includes(item.id) ? sizeColor : ''"      href="javascript:void(0)">{{ item.text }}</a></li>
                                            ...
                                            <div class="shop-color-list">
                                                <ul>
                                                    <li v-for="item in colors" :key="item.id"
                                                      v-on:click="addDataAttr('color',item.id)"   :class="this.color.includes(item.id) ? colorColor : ''"   :style="{ backgroundColor: item.value}"></li>
